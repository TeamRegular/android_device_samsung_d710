...
public class Epic4GTouchRIL extends RIL implements CommandsInterface {
    ...
    protected HandlerThread mSamsungEpic4GTouchRILThread;
    protected ConnectivityHandler mSamsungEpic4GTouchRILHandler;
    ...
    public void setPreferredNetworkType(int networkType , Message response) {
        ...
        if(NeedReconnect())
        {
            if (mSamsungEpic4GTouchRILHandler == null) {

                handlerThread = new HandlerThread("mSamsungEpic4GTouchRILThread");
                mSamsungEpic4GTouchRILThread = handlerThread;

                mSamsungEpic4GTouchRILThread.start();

                looper = mSamsungEpic4GTouchRILThread.getLooper();
                mSamsungEpic4GTouchRILHandler = new ConnectivityHandler(mContext, looper);
            }
            mSamsungEpic4GTouchRILHandler.setPreferedNetworkType(networkType, response);
        } else {
            if (mSamsungEpic4GTouchRILHandler != null) {
                mSamsungEpic4GTouchRILThread = null;
                mSamsungEpic4GTouchRILHandler = null;
            }
